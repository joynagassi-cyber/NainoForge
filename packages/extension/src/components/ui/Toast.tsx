  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex h-11 w-11 items-center justify-center rounded-full opacity-80 hover:opacity-100 transition-all focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
      >
        <X className="h-4 w-4" />
      </button>
    </motion.div>
